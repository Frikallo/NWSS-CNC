...
class DesignerView : public QGraphicsView {
 ...
 public:
  enum Tool { Select, Measure, Pan };

  enum Snap { NoSnap, Grid, Object };
  ...
  QPair<QRectF, QRectF> calculateLabelPositions(const QString &materialLabel,
                                                const QString &bedLabel,
                                                const QFont &materialFont,
                                                const QFont &bedFont) const;
 ...
 signals:
  ...
  void convertToGCode(const QString &svgFile, QRectF designBounds,
                      double designScale, QPointF designOffset);
 ...
 private:
  ...
  QString createCroppedSvg(const QString &originalSvg,
...
class TransformCommand : public QUndoCommand {
 public:
  TransformCommand(DesignerView *view, const QList<QGraphicsItem *> &items,
                   ...
                   const QList<QTransform> &newTransforms, const QString &text);
