...
class CAMProcessor {
 public:
   ...
   */
  CAMOperationResult validateToolpathFeasibility(const Polygon &polygon,
                                                 double toolDiameter,
 ...
 private:
  ...
  Clipper2Lib::Paths64 polygonsToClipperPaths(
      const std::vector<Polygon> &polygons);
  std::vector<Polygon> clipperPathsToPolygons(
