...
class Utils {
 public:
  ...
  static bool savePathsToCSV(const std::vector<Path> &paths,
                             const std::string &filename);

  // Generate a visualization SVG showing the original shapes and discretized
  // points
  static bool generateVisualization(const std::string &sourceFile,
                                    const std::vector<Path> &paths,
                                    const std::string &outputFile);

  // Generate a visualization showing how the design fits on the material and
  // bed
