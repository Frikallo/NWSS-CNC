...
bool CNConfig::loadFromFile(const std::string &filename) {
  ...
  while (std::getline(file, line)) {
    ...
    if (section == "machine") {
      if (key == "bed_width")
        m_bedWidth = std::stod(value);
      else if (key == "bed_height")
        m_bedHeight = std::stod(value);
      else if (key == "units")
        setUnitsFromString(value);
    } else if (section == "material") {
      if (key == "width")
        m_materialWidth = std::stod(value);
      else if (key == "height")
        m_materialHeight = std::stod(value);
      else if (key == "thickness")
        m_materialThickness = std::stod(value);
    } else if (section == "cutting") {
      if (key == "feed_rate")
        m_feedRate = std::stod(value);
      else if (key == "plunge_rate")
        m_plungeRate = std::stod(value);
      else if (key == "spindle_speed")
        m_spindleSpeed = std::stoi(value);
      else if (key == "cut_depth")
        m_cutDepth = std::stod(value);
      else if (key == "pass_count")
        m_passCount = std::stoi(value);
      else if (key == "safe_height")
        m_safeHeight = std::stod(value);
    }
  }
...
bool CNConfig::parseLine(const std::string &line, std::string &key,
