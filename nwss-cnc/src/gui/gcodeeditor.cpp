...
GCodeEditor::GCodeEditor(QWidget *parent) : QPlainTextEdit(parent) {
  ...
  connect(this, &GCodeEditor::blockCountChanged, this,
          &GCodeEditor::updateLineNumberAreaWidth);
  connect(this, &GCodeEditor::updateRequest, this,
          &GCodeEditor::updateLineNumberArea);
  connect(this, &GCodeEditor::cursorPositionChanged, this,
          &GCodeEditor::highlightCurrentLine);

  updateLineNumberAreaWidth(0);
  highlightCurrentLine();

  // Declare font variable at this scope so it's available throughout the
  // function
  QFont editorFont;
...
void GCodeEditor::setupCustomCursor() { setCursorWidth(2); }
